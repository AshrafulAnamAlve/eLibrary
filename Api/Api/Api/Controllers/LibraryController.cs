...
namespace Api.Controllers
{
    ...
    public class LibraryController : ControllerBase
    {
        ...
        public ActionResult PostRegister(User user)
        {
            ...
            return Ok("@Thank you for registering. your account has been sent for aprooval.Once it is aprooved, you will get an email.");
        }
        ...
        {
            var orders = Context.Orders.Include(o=>o.Book).Include(o=>o.User).Where(o=>o.UserId ==userId).ToList();
            if (orders.Any())
            {
                return Ok(orders);
            }
        ...
        [Authorize]
        [HttpGet("GetUsers")]
        public ActionResult GetUsersap()
        {
                    ...
                    EmailService.SendEmail(user.Email, "Account Approved", $"""
                        <html>
                         <body>
                            ...
                            <h3>Your Account has been approved by admin.</h3>
        ...
        [Authorize]
        [HttpGet("BlockFineOverdueUser")]
        public ActionResult BlockFineOverdueUser()
        {
            var orders = Context.Orders.Include(o => o.Book).Include(o => o.User).Where(o => !o.Returned).ToList();
